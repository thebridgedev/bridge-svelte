...
import { initBridge } from '../../core/bridge-instance.js';
import { logger, setLoggerDebug } from '../../shared/logger.js';
...
export const bridgeConfig = {
  ...
  initConfig: (config: BridgeConfig, routeConfig?: RouteGuardConfig) => {
    ...
    // Initialize logger debug mode before anything else
    setLoggerDebug(!!merged.debug);

    // Initialize the singleton BridgeAuth instance
    initBridge(merged);
